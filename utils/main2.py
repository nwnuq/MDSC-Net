...
# @Author  : Ran Gu
import os
os.environ['CUDA_VISIBLE_DEVICES'] = '3'  # 确定要使用的GPU
import torch
import math
# import visdom
...
from Models.networks.testModel import ConvNeXt
...
Test_Model = {'convnext': ConvNeXt}
# Test_model1 = {'unet': UNet}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--device', type=str, default='1', help='the choices of GPU')
