...
class AttU_Net(nn.Module):
    def __init__(self, args, n_channels=3, n_classes=2, scale_factor=1):
        ...
        self.Conv_1x1 = nn.Sequential(
            nn.Conv2d(filters[0], n_classes, kernel_size=1, stride=1, padding=0),
            nn.Softmax2d()
        )
...
if __name__ == '__main__':
    ...
    tt = torch.randn((1, 3, 256, 256))
    net = AttU_Net(n_channels=3, n_classes=2)
    s = net(tt)
    print(s.shape)
