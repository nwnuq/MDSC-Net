...
sys.path.append('/home/sdc_3_7T/jiangyun/QunZ/PF/PFKJ-V2/Models/msred/')
import torch
import torch.nn as nn
import torch.nn.functional as F
from modules import UnetDsv3
from scale_attention_layer import scale_atten_convblock
from scale_attention_layer_softpool import scale_atten_convblock_softpool
...
class Ms_red_v1(nn.Module):
    def __init__(self, args, classes=2, channels=3):
        """
...
class Ms_red_v2(nn.Module):
    def __init__(self, args, classes, channels):
        """
        :param classes: the object classes number.
        :param channels: the channels of the input image.
        """
